<x-app-layout>
            ...
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        {{-- roles count thakle show korbe if r na thakle empty --}}
                        @if($roles->count())
                        {{-- akhane  foreach er maddhome database er value nia asbo--}}
    ...
    {{-- permission id te opore role id dia dibo --}}
    <script>
