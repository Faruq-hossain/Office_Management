        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                ...
                <form action="{{ route('roles.store') }}" method="POST" class="p-4">
                    ...
                    {{-- show permission frontend --}}
                    {{-- value te data pass korte hbe permission id --}}
                    {{-- proti lavel er  click korle data jabena seta korar jonno id and for e permission_id bosate hobe and trpor alada click korte parbo--}}
